...
def wordsTill99999(n):
    ...
    if tenTh==1:
        ...
        5:'fifteen',6:'sixteen',7:'seventeen',8:'eighteen',9:'nineteen'}
        word=unitsOfTenTh[thousand//1000] + ' thousand '+spellingWordsTill999(thousand)
    if thousand==2:
        word='twenty thousand '+spellingWordsUpto9999(thousand)
    elif thousand==3:
        word='thirty thousand '+spellingWordsUpto9999(thousand)
    elif thousand==4:
        word='forty thousand '+spellingWordsUpto9999(thousand)
    elif thousand==5:
        word='fifty thousand '+spellingWordsUpto9999(thousand)
    elif thousand==6:
        word='sixty thousand '+spellingWordsUpto9999(thousand)
    elif thousand==7:
        word='seventy thousand '+spellingWordsUpto9999(thousand)
    elif thousand==8:
        word='eighty thousand '+spellingWordsUpto9999(thousand)
    elif thousand==9:
        word='ninety thousand '+spellingWordsUpto9999(thousand)
    return word
